  ...
  return (
    <section className="py-32 bg-black relative z-10 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <h2 className="text-4xl md:text-6xl font-serif text-white mb-16 tracking-tight">
          ...
          {categories.map((category) => {
            ...
            return (
              <div 
                ...
                className={cn(
                  "relative rounded-2xl overflow-hidden cursor-pointer transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]",
                  isActive 
              ...
              >
                ...
                <div className={cn(
                  ...
                  <div className={cn(
                    ...
                    <h3 className={cn(
                      "font-serif text-3xl md:text-4xl text-white tracking-wide",
