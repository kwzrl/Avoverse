				...
				<main>
					...
					<div className="relative h-screen w-full overflow-hidden">
						...
						<div className="relative z-20 h-full flex flex-col items-center justify-center text-center px-4 md:px-6 pointer-events-none">
							<div className="pointer-events-auto max-w-4xl mx-auto space-y-8 animate-in fade-in zoom-in-95 duration-1000 slide-in-from-bottom-10">
								...
								<div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
									<Button 
										size="lg" 
										className="rounded-[4px] h-12 px-8 text-[15px] font-medium bg-white text-black hover:bg-neutral-200 transition-colors"
									>
										Join Waitlist
									</Button>
									<Button 
										size="lg" 
										variant="outline" 
										className="rounded-[4px] h-12 px-8 text-[15px] font-medium border-white/20 bg-transparent text-white hover:bg-white/10 hover:text-white transition-colors hover:border-white/40"
									>
						...
						{/* Scroll Indicator */}
						<div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-20 animate-bounce pointer-events-none text-white/50">
					...
					<section className="py-32 bg-neutral-950 relative z-10">
						<div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
							<div className="space-y-6">
								...
								<Button variant="link" className="text-white p-0 h-auto text-lg underline-offset-4 decoration-white/30 hover:decoration-white">
							...
							<div className="aspect-square md:aspect-[4/5] rounded-lg overflow-hidden relative bg-neutral-900 border border-white/5">
								...
								<div className="absolute inset-0 flex items-center justify-center text-white/20 font-serif italic text-4xl">
									Visuals
								</div>
							</div>
						</div>
